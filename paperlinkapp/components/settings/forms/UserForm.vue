<template>
  ...
  >
    ...
    <span class="inline-flex items-center gap-3">
      <span v-show="!this.isLocationError" class="text-[12px]"
        >Click on icon to pin your location for us to get your timezone, city and country.
      </span>
      <span v-show="this.isLocationError" class="text-[12px] text-red-600"
        >Error occure while trying to get your location, please try again
      </span>
      <span
        class="cursor-pointer"
        @click="fetchUserCountryDetail"
        v-show="!this.isLocationFetching"
      >
        <location-icon />
      </span>
