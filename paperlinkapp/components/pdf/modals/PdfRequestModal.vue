<template>
  ...
  >
    ...
    <!--End:: Close Button -->
    <template #title>
      <h4 class="text-center font-semibold text-2xl text-gray-800 pb-2">Share</h4>
    </template>
    <!-- Start:: Body -->
    <form @submit.prevent="onSubmit" action="" class="max-w-[470px] mx-auto">
      ...
      <div class="flex justify-around pt-5">
        <button
          class="disabled:bg-opacity-50 disabled:cursor-progress h-10 text-xs w-[100%] text-white rounded-md shadow bg-paperdazgreen-400"
          :disabled="loading"
        >
