<template>
  <div class="font-family !bg-white">
    ...
    <section class="px-4 mb-8">
      <div class="w-full text-[1.5rem] font-[600] text-center px-2 py-12">
      ...
      <div class="flex flex-wrap justify-center items-center">
        ...
        >
          <p class="font-normal text-start text-[1rem] py-4 w-full leading-[30px]">
          ...
          <p class="font-normal text-[1rem] py-4 w-full leading-[30px]">
