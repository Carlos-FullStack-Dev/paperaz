...
export const sendContactUsMail= async (data:any) => {
  ...
  var mail = {
    ...
    to: app.get("email_to") ,
    subject: "PaperLink, Contact Us"+` #${Math.floor(Math.random() * (10000 - 1 + 1) + 1)}`,
    html: `
          ...
          * {
          ...
          <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
            ...
            <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
              <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 20px; line-height: 28px; font-family: 'Open Sans', sans-serif;"><strong>Contact US</strong></span></p>
            </div>
            ...
            <div style="line-height: 160%; text-align: left; word-wrap: break-word;">
              <div style="font-size: 14px; line-height: 160%;display: flex;align-items: center;">
                  ...
                  <div  class="u-col-larger" >
                      <p> Hi you got a message</p>
                  </div>
              </div>
          <p style="font-size: 14px; line-height: 160%;"> </p>
          <p style="font-size: 14px; line-height: 160%;padding: 1em 0;"><span style="font-size: 18px; line-height: 28.8px;">Name: ${data.firstName} ${data.lastName}</span></p>
          <p style="font-size: 14px; line-height: 160%;"> </p>
          <p style="font-size: 14px; line-height: 160%;padding: 1em 0;"><span style="font-size: 18px; line-height: 28.8px;">Email: ${data.email}</span></p>
          <p style="font-size: 14px; line-height: 160%;"> </p>
          <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;"><strong><span style="line-height: 17.8px; font-size: 18px;">Message: ${data.message}</span></strong></span></p>
            </div>
