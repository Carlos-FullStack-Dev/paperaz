...
export const sendPermissionGranted = async (user: any, quest:any, permissionLink:string, file:any) => {
  ...
  var mail = {
    ...
    to: quest.email,
    subject: "PaperLink, Private File Access Granted"+` #${Math.floor(Math.random() * (10000 - 1 + 1) + 1)}`,
    html: `
            ...
            <div
                ...
                <p
                    ...
                    <span
                        ...
                        Hi ${quest.firstName || quest.email},</span></p>
                <p style=" line-height: 160%;"><span
                        style=" line-height: 10px; ">
                        ${user.companyName}, has approved access to ${file.fileAction} file. Click on the link below to open file</span></p>
                ...
                <a href="${permissionLink}"
                    ...
                    <span
                        style="display:block;padding:0px 0px; font-weight: 500;"><span
                            ><span
                                    style=" font-size: 16px;">${file.fileName}</span></span></span>
                </a>
            </div>
