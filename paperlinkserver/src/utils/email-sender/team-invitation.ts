...
export const sendTeamInvite = async (email: string, business:any, invitationLink:string) => {
  ...
  var mail = {
    ...
    to: email,
    subject: "PaperLink, Team Invitation"+` #${Math.floor(Math.random() * (10000 - 1 + 1) + 1)}`,
    html: `
        ...
        <td style="overflow-wrap:break-word;word-break:break-word"
            ...
            <div
                ...
                <p style=" line-height: 160%;"><span
                        ...
                        ${business.companyName}, has added you as a team member. Click on the link below, then create a password to join</span></p>
                ...
                <a href="${invitationLink}"
                    ...
                    <span
                        style="display:block;padding:0px 0px; font-weight: 500;"><span
                            ><span
                                    style=" font-size: 16px;">Verify Email</span></span></span>
                </a>
            </div>
