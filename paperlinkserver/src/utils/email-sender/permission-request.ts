...
export const sendPermissionRequest = async (
  business: any,
  guest: any,
  ...
  var mail = {
    ...
    to: business.email,
    subject: 'PaperLink, Private File Request' + ` #${Math.floor(Math.random() * (10000 - 1 + 1) + 1)}`,
    html: `
    ${email_header}
            ...
            <div
                ...
                <p
                    ...
                    <span
                        ...
                        Hi
                        $ ${business.companyName ?? business.firstName},</span></p>
                <p style=" line-height: 160%;"><span
                        style=" line-height: 10px; ">
                        ${guest.name} ${guest.email}, has request access to <b>${fileName}</span></p>
                ...
                <a href="${permissionLink}"
                    ...
                    <span
                        style="display:block;padding:0px 0px; font-weight: 500;"><span
                            ><span
                                    style=" font-size: 16px;">Click here to manage access</span></span></span>
                </a>
            </div>
