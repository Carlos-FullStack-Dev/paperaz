...
import billings from './billings/billings.service';
...
import handleFileQue from './handle-file-que/handle-file-que.service';

import teams from './teams/teams.service';

import teammembers from './teammembers/teammembers.service';

import junologixStates from './junologix_states/junologix_states.service';
...
export default function (app: Application): void {
  ...
  app.configure(handleFileQue);
  app.configure(teams);
  app.configure(teammembers);
  app.configure(junologixStates);
}
