...
import handleFileRemovePrefills from '../../middleware/handle-file-remove-prefills';
...
export default function (app: Application): void {
  ...
  multer({
    ...
    storage: multerS3({
      ...
      s3: new aws.S3({
        //@ts-ignore
        accessKeyId: app.get('DO_SPACES_KEY') || null,
        //@ts-ignore
        secretAccessKey: app.get('DO_SPACES_SECRET') || null,
        //@ts-ignore
        endpoint: app.get('DO_SPACES_ENDPOINT') || null,
        signatureVersion: "v4"
      }),
      //@ts-ignore
      bucket: app.get('DO_SPACES_BUCKET') || null,
